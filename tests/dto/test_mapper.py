...
@with_language_context
def test_map_core_competences():
    """Test mapping a collection of core competences."""
    core_competences = lcm.CoreCompetences(items=[
...
def test_map_experience():
    ...
    experience = lcm.Experience(
        company=lcm.Company(name="Tech Innovations Inc."),
...
@with_language_context
def test_map_education():
    """Test mapping an educational experience."""
    education = lcm.Education(
        university=lcm.University(name="Stanford University"),
...
@with_language_context
def test_map_skill_group():
    """Test mapping a skill group."""
    skill_group = lcm.SkillGroup(
        name="Programming Languages",
        skills=[
            lcm.Skill(text="Python"),
            lcm.Skill(text="JavaScript")
        ]
    )
...
def test_map_cv():
    ...
    assert dto.summary.text == "Experienced software engineer with a passion for innovative solutions"
    assert dto.language == ENGLISH