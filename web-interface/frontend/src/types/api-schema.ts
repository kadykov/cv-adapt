...
export interface paths {
    ...
    "/user/detailed-cvs": {
         ...
         */
        get: operations["get_user_detailed_cvs_user_detailed_cvs_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/user/detailed-cvs/{language_code}": {
         ...
         */
        get: operations["get_user_detailed_cv_user_detailed_cvs__language_code__get"];
        /**
         * Upsert User Detailed Cv
         * @description Create or update user's detailed CV for a language.
         */
        put: operations["upsert_user_detailed_cv_user_detailed_cvs__language_code__put"];
        post?: never;
        /**
         * Delete User Detailed Cv
         * @description Delete user's detailed CV by language.
         */
        delete: operations["delete_user_detailed_cv_user_detailed_cvs__language_code__delete"];
        options?: never;
        head?: never;
        patch?: never;
        trace?: never;
    ...
    "/user/detailed-cvs/{language_code}/primary": {
         ...
         */
        put: operations["set_primary_cv_user_detailed_cvs__language_code__primary_put"];
        post?: never;
        delete?: never;
        options?: never;
        head?: never;
    ...
    "/api/generate-competences": {
         ...
         */
        post: operations["generate_competences_api_generate_competences_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/api/generate-cv": {
         ...
         */
        post: operations["generate_cv_api_generate_cv_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/generate": {
         ...
         */
        post: operations["generate_and_save_cv_generate_post"];
        delete?: never;
        options?: never;
        head?: never;
        patch?: never;
    ...
    "/generations": {
         ...
         */
        get: operations["get_user_generations_generations_get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
    ...
    "/generations/{cv_id}": {
         ...
         */
        get: operations["get_generated_cv_generations__cv_id__get"];
        put?: never;
        post?: never;
        delete?: never;
        options?: never;
...
export interface operations {
    ...
    refresh_token_v1_auth_refresh_post: {
        ...
        requestBody: {
            content: {
                "application/json": components["schemas"]["Body_refresh_token_v1_auth_refresh_post"];
            };
        };
        responses: {
            /** @description Successful Response */
    ...
    get_user_detailed_cvs_user_detailed_cvs_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    get_user_detailed_cv_user_detailed_cvs__language_code__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    upsert_user_detailed_cv_user_detailed_cvs__language_code__put: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    delete_user_detailed_cv_user_detailed_cvs__language_code__delete: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    set_primary_cv_user_detailed_cvs__language_code__primary_put: {
        parameters: {
            query?: never;
            header?: never;
            path: {
    ...
    generate_competences_api_generate_competences_post: {
        parameters: {
            query?: {
                language_code?: string;
            };
    ...
    generate_cv_api_generate_cv_post: {
        parameters: {
            query?: {
                language_code?: string;
            };
    ...
    generate_and_save_cv_generate_post: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    get_user_generations_generations_get: {
        parameters: {
            query?: never;
            header?: never;
            path?: never;
    ...
    get_generated_cv_generations__cv_id__get: {
        parameters: {
            query?: never;
            header?: never;
            path: {
