...
export type LoginRequest =
  components['schemas']['Body_login_v1_api_auth_login_post'];
export type User = components['schemas']['UserResponse'];

// Job types
export type JobDescriptionCreate =
  components['schemas']['JobDescriptionCreate'];
export type JobDescriptionUpdate =
  components['schemas']['JobDescriptionUpdate'];
export type JobDescriptionResponse =
  components['schemas']['JobDescriptionResponse'];
...
export type GenerateCompetencesRequest =
  components['schemas']['GenerateCompetencesRequest'];
