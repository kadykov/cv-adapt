...
describe('AuthDialog', () => {
  ...
  it('shows correct heading in DialogTitle', async () => {
    renderDialog();
    await waitFor(() => {
  ...
  it('starts with register view when initialView is register', async () => {
    renderDialog({ initialView: 'register' });
  ...
  it('renders dialog with correct structure and styling', async () => {
    renderDialog();
