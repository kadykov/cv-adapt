...
async def handle_validation_error(request: Request, exc: RequestValidationError) -> Dict[str, Any]:
...
def setup_logging_middleware(app: FastAPI) -> None:
    ...
    async def validation_exception_handler(request: Request, exc: RequestValidationError):
        ...
        duration = round((time.time() - request.state.start_time) * 1000, 2) if hasattr(request.state, "start_time") else None
