...
def map_core_competence(core_competence: language_context_models.CoreCompetence) -> cv_dto.CoreCompetenceDTO:
    return cv_dto.CoreCompetenceDTO(
        text=core_competence.text
    )


def map_core_competences(core_competences: language_context_models.CoreCompetences) -> cv_dto.CoreCompetencesDTO:
    return cv_dto.CoreCompetencesDTO(
        items=[map_core_competence(cc) for cc in core_competences.items]
    )


def map_institution(institution: language_context_models.Institution) -> cv_dto.InstitutionDTO:
...
def map_experience(experience: language_context_models.Experience) -> cv_dto.ExperienceDTO:
...
def map_skill_group(skill_group: language_context_models.SkillGroup) -> cv_dto.SkillGroupDTO:
