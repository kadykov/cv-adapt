...
async def create_async_title_generator(
    ...
    """
    Create an async title generator.
...
def get_title_generator(
    ...
    Generator[ComponentGenerationContext, cv_dto.TitleDTO],
    Awaitable[AsyncGenerator[ComponentGenerationContext, cv_dto.TitleDTO]],
]:
    """
    Get a title generator based on the async flag.
    ...
    Returns:
        Either a sync or async generator for professional titles
    """
    if use_async:
        return create_async_title_generator(
            ai_model, system_prompt_template_path, context_template_path
        )
    return create_title_generator(
        ai_model, system_prompt_template_path, context_template_path
    )
