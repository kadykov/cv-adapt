...
async def create_async_core_competence_generator(
...
def get_core_competence_generator(
    ai_model: KnownModelName = "openai:gpt-4o",
    system_prompt_template_path: Optional[str] = None,
    context_template_path: Optional[str] = None,
    ...
    Generator[CoreCompetenceGenerationContext, List[CoreCompetenceDTO]],
    Awaitable[AsyncGenerator[CoreCompetenceGenerationContext, List[CoreCompetenceDTO]]],
]:
    """
    Get a core competence generator based on the async flag.
    ...
    Returns:
        Either a sync or async generator for core competences
    """
    if use_async:
        return create_async_core_competence_generator(
            ai_model, system_prompt_template_path, context_template_path
        )
    return create_core_competence_generator(
        ai_model, system_prompt_template_path, context_template_path
    )
