...
class CVAdapter:
    ...
    def adapt_experience(
        self, experience: Experience, core_competences: List[CoreCompetence]
    ) -> Experience:
        """
        Adapt a single experience description to highlight aspects that align with
        the selected core competences.
        """
    ...
    def adapt_cv(self, cv: CV, core_competences: List[CoreCompetence]) -> CV:
        ...
        adapted_cv.summary = CVSummary(text=self.generate_summary(core_competences))
